...
public class ClientPersistenceTest {
    ...
    public void createClientTest() {
        ...
        newEntity.setIdCard(generateRandom(String.class));
        ...
        Assert.assertEquals(newEntity.getIdCard(), entity.getIdCard());
    ...
    public void getClientTest() {
        ...
        Assert.assertEquals(entity.getIdCard(), newEntity.getIdCard());
    ...
    public void updateClientTest() {
        ...
        Assert.assertEquals(newEntity.getIdCard(), resp.getIdCard());

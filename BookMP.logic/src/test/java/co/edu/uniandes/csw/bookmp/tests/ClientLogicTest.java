...
import co.edu.uniandes.csw.bookmp.ejbs.ClientLogic;
import co.edu.uniandes.csw.bookmp.api.IClientLogic;
import co.edu.uniandes.csw.bookmp.converters.ClientConverter;
import co.edu.uniandes.csw.bookmp.dtos.ClientDTO;
import co.edu.uniandes.csw.bookmp.entities.ClientEntity;
import co.edu.uniandes.csw.bookmp.persistence.ClientPersistence;
...
public class ClientLogicTest {
    ...
    private void insertData() {
        for (int i = 0; i < 3; i++) {
        	...
        	entity.setIdCard(generateRandom(String.class));
    ...
    public void createClientTest() {
        ...
        dto.setIdCard(generateRandom(String.class));
        ...
        Assert.assertEquals(dto.getIdCard(), entity.getIdCard());
    ...
    public void getClientTest() {
        ...
        Assert.assertEquals(entity.getIdCard(), dto.getIdCard());
    ...
    public void updateClientTest() {
        ...
        Assert.assertEquals(dto.getIdCard(), resp.getIdCard());
